...
//  role   = "${data.aws_iam_role.pas_bucket_access.id}"
////  policy = "${data.template_file.pas_backup_bucket_policy.rendered}"
//
//  count = "${var.create_backup_pas_buckets ? 1 : 0}"
//}
...
//  target_key_id = "${data.aws_kms_key.blobstore_kms_key.key_id}"
//}
...
//    kms_key_arn           = "${data.aws_kms_key.blobstore_kms_key.arn}"
//  }
//}
...
//  name = "${var.env_name}_pas_bucket_access"
//  role = "${data.aws_iam_role.pas_bucket_access.name}"
//}
